...
const COMMANDS = [
  ...
  },
  {
    ...
    params: ["id"],
    write: true,
    description: "删除 Provider 连接",
  },
  {
    name: "provider-nodes:list",
    method: "GET",
    path: "/api/provider-nodes",
    auth: true,
    description: "列出自定义 Provider 节点",
  },
  {
    name: "provider-nodes:create",
    method: "POST",
    path: "/api/provider-nodes",
    auth: true,
    body: true,
    write: true,
    description: "创建自定义 Provider 节点",
  },
  {
    name: "provider-nodes:update",
    method: "PUT",
    path: "/api/provider-nodes/{id}",
    auth: true,
    params: ["id"],
    body: true,
    write: true,
    description: "更新自定义 Provider 节点",
  },
  {
    name: "provider-nodes:delete",
    method: "DELETE",
    path: "/api/provider-nodes/{id}",
    auth: true,
    params: ["id"],
    write: true,
    description: "删除自定义 Provider 节点及其连接",
  },
  {
    name: "provider-nodes:validate",
    method: "POST",
    path: "/api/provider-nodes/validate",
    auth: true,
    body: true,
    write: true,
    description: "验证自定义 Provider 节点配置",
  },
  {
    name: "models:list",
    method: "GET",
...
function printHelp() {
  const lines = [
    ...
    "  providers:create --file provider.json --yes",
    "                               创建 Provider 连接",
    "  providers:update <id> --file patch.json --yes",
    "                               更新 Provider 连接",
    "  providers:delete <id> --yes   删除 Provider 连接",
    "  provider-nodes:list          列出自定义 Provider 节点",
    "  provider-nodes:create --file node.json --yes",
    "                               创建自定义 Provider 节点",
